...
for %%L in (%LANGUAGES%) do (
    pyside6-lupdate main.py ui/setting_dialog.py ui/queue_dialog.py ui/user_guide_dialog.py -ts modules/translations/app_en.ts modules/translations/app_%%L.ts
